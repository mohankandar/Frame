 ...
 *
 */
public final class BipCommonSpringProfiles {
	 ...
	 * Do not instantiate.
	 */
	private BipCommonSpringProfiles() {
		throw new IllegalStateException(BipCommonSpringProfiles.class.getSimpleName() + BipConstants.ILLEGALSTATE_STATICS);
	}
}
