...
import com.wynd.vop.framework.exception.BipException;
import com.wynd.vop.framework.exception.BipExceptionExtender;
import com.wynd.vop.framework.exception.BipPartnerException;
...
import com.wynd.vop.framework.shared.sanitize.SanitizerException;
import com.wynd.vop.framework.util.HttpHeadersUtil;
import com.wynd.vop.framework.exception.*;
...
public class BipRestGlobalExceptionHandler extends BaseHttpProviderPointcuts {
	...
	private ResponseEntity<Object> jsonExceptionHandler(
		...
		if (mostSpecificCause instanceof JsonParseException) {
			...
			BipRuntimeException vopRuntimeException = (BipRuntimeException) mostSpecificCause;
			...
			BipException vopException = (BipException) mostSpecificCause;
