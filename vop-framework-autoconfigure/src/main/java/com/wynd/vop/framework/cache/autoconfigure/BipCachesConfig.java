...
import com.wynd.vop.framework.cache.autoconfigure.BipRedisCacheProperties.RedisExpires;
import com.wynd.vop.framework.cache.interceptor.BipCacheInterceptor;
...
public class BipCachesConfig extends CachingConfigurerSupport {
	...
	@Autowired
	private BipRedisCacheProperties vopRedisCacheProperties;
	...
	public void postConstruct() {
		Defense.notNull(vopRedisCacheProperties, BipRedisCacheProperties.class.getSimpleName() + " cannot be null.");
	}
	...
	public RedisCacheManager cacheManager(final RedisConnectionFactory redisConnectionFactory) {
		if (LOGGER.isDebugEnabled()) {
			...
			if (vopRedisCacheProperties.getExpires() != null) {
				...
				for (BipRedisCacheProperties.RedisExpires expires : vopRedisCacheProperties.getExpires()) {
	...
	public CacheInterceptor cacheInterceptor() {
		...
		CacheInterceptor interceptor = new BipCacheInterceptor(vopRedisCacheProperties.isAllowNullReturn());
